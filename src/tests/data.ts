...
const records: ClipboardEntry[] = [
  ...
  // 【文件类型 - 混合文件和文件夹】
  { type: "files", value: [{ isFile: true, isDirectory: false, name: ".gitignore", path: "C:\\Users\\lxy\\Pictures\\.gitignore" }, { isFile: false, isDirectory: true, name: "Screenshots", path: "C:\\Users\\lxy\\Pictures\\Screenshots" }], timestamp: 1763011472062, hash: "cc0717c20de72119f3c6a2e35e400b47" },

  // 【文件类型 - 多个图片文件】
  { type: "files", value: [{ isFile: true, isDirectory: false, name: "lazyeat.png", path: "C:\\Users\\lxy\\Pictures\\lazyeat.png" }, { isFile: true, isDirectory: false, name: "images.jpg", path: "C:\\Users\\lxy\\Pictures\\images.jpg" }], timestamp: 1763011455970, hash: "c5ea0a41e4b25bbad7e13b63beaef6ef" },

  // 【文件类型 - 单个图片文件】
  { type: "files", value: [{ isFile: true, isDirectory: false, name: "images.jpg", path: "C:\\Users\\lxy\\Pictures\\images.jpg" }], timestamp: 1763011433834, hash: "9390e121af9127ba1ae5aceb63a3cf68" },

  // 【文件类型 - 多个普通文件】
  { type: "files", value: [{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" },{ isFile: true, isDirectory: false, name: "package.json", path: "C:\\work_sapce\\rubick-jtb\\package.json" }, { isFile: true, isDirectory: false, name: "index.html", path: "C:\\work_sapce\\rubick-jtb\\index.html" }, { isFile: true, isDirectory: false, name: "LICENSE", path: "C:\\work_sapce\\rubick-jtb\\LICENSE" }], timestamp: 1763011405664, hash: "6a74bb1ed217aa08ceee847f8b436cad" },
  ...
  // 【文本类型 - 单行文本】
  { type: "text", value: "这是单行文本。", timestamp: 1763011323158, hash: "9af8eff2903b4d787499d4f361462058" },
];
